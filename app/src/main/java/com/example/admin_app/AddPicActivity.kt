...
import com.example.admin_app.databinding.ActivityAddPicBinding
...
class AddPicActivity : AppCompatActivity() {
    private lateinit var binding: ActivityAddPicBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityAddPicBinding.inflate(layoutInflater)
      ...
      binding.selectpic.setOnClickListener {
        ...
        binding.submit.setOnClickListener {
            ...
            if (selectedPhotoUri != null) {
                ...
                val ref = FirebaseStorage.getInstance().getReference("/Gallery/$picname")
                val bitmap =
                ...
                ref.putBytes(reducedImage)
                    .addOnSuccessListener {
                        ...
                        ref.downloadUrl.addOnSuccessListener {
                            ...
                            val diagnosis = db.collection("Gallery").document(picname).set(data)
                                .addOnSuccessListener {
                                    Log.e("success", "${data}")
                                    val toast =
                                        Toast.makeText(
